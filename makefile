...
TEST_SRC = $(TEST_DIR)/main_test.c $(TEST_DIR)/add_test.c $(TEST_DIR)/multiply_test.c $(TEST_DIR)/more_tests.c
TEST_OBJ = $(BIN_DIR)/main_test.o $(BIN_DIR)/add_test.o $(BIN_DIR)/multiply_test.o $(BIN_DIR)/more_tests.o
